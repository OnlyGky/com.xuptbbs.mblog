...
import com.xuptbbs.mblog.base.oauth.*;
import com.xuptbbs.mblog.base.oauth.*;
import com.xuptbbs.mblog.base.oauth.utils.OpenOauthBean;
import com.xuptbbs.mblog.base.oauth.utils.TokenUtil;
import com.xuptbbs.mblog.base.utils.FilePathUtils;
import com.xuptbbs.mblog.base.utils.ImageUtils;
...
//            throw new MtonsException("缺少必要的参数");
//        }
//        System.out.println(StringUtils.isBlank(state));
//        System.out.println(StringUtils.isBlank(session_state));
//        System.out.println(!state.equals(session_state));
//        System.out.println(StringUtils.isBlank(code));
        request.getSession().removeAttribute(SESSION_STATE);
